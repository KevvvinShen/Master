...
<body>
	...
	<section>
        <div class="container">
            ...
            <div class="col-md-12 text-center">
            <h3>餐廳管理員註冊</h3>
                    <form action="admin_insert.php" method="get">
                        <div class="row">
                            <div class="col-md-4 col-md-offset-4">
                                ...
                                <div class="form-group">
                                    <input type="text" class="form-control" name="account" placeholder="註冊管理者帳號 *">
                                </div>
                                <div class="form-group">
                                    <input type="password" class="form-control" name="password" placeholder="註冊管理員密碼 *">
                                </div>
                                <div class="form-group">
