...
<body>
	...
	<section>
        <div class="container">
            ...
            <div class="col-md-12 text-center">
                <h3>會員註冊</h3>
                    <form action="admin_customer_insert.php" method="get">
                        <div class="row">
                            <div class="col-md-4 col-md-offset-4">
                                ...
                                <div class="form-group">
                                    <input type="text" class="form-control" name="account" placeholder="註冊會員帳號 *">
                                </div>
                                <div class="form-group">
                                    <input type="password" class="form-control" name="password" placeholder="註冊會員密碼 *">
                                </div>
                                <div class="form-group">
                                    <input type="password" class="form-control" name="check_password" placeholder="請再輸入一次密碼 *">
                                </div>
                                <div class="form-group">
                                <h5 align="left">生日</h5>
